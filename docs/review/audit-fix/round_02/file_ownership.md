...
- sparrow-engine/sparrow-engine-cpu/src/engine.rs  # added by ITEM-REV-R2-001 MODIFY approval
...
- sparrow-engine/sparrow-engine-cpu/src/engine.rs  (mid-round discovery; appended to ledger as added_round=2)
